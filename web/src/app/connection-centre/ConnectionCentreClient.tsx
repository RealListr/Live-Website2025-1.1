// src/app/connection-centre/ConnectionCentreClient.tsx
// @ts-nocheck
"use client";
...
const UI: Record<string, any> = {
  ...
  ar: {
    ...
    zoning: "التصنيف",
    landArea: "مساحة الأرض (m²)",
    floorArea: "مساحة البناء (m²)",
    nabers: "NABERS",
...
/* ---------- main component ---------- */
export default function ConnectionCentreClient() {
  const [agents, setAgents] = useState([
    { name: "Aisha Patel", avatarUrl: "" },
  ]);
  ...
  const chips = useMemo(() => {
    const items: string[] = [];
    items.push(
      `🛏 ${content.beds} ${ui.beds?.toLowerCase?.() || "bed"}`
    );
    items.push(
      `🛁 ${content.baths} ${ui.baths?.toLowerCase?.() || "bath"}`
    );
    items.push(
      `🚗 ${content.cars} ${ui.cars?.toLowerCase?.() || "car"}`
    );
    if (content.landArea)
      items.push(
        `m² ${content.landArea} ${
          ui.landArea?.toLowerCase?.() || "land"
        }`
      );
    if (content.floorArea)
      items.push(
        `m² ${content.floorArea} ${
          ui.floorArea?.toLowerCase?.() || "bldg"
        }`
      );
    return items;
  }, [content, ui]);
  ...
  const onPickListr = async (files: FileList | null) => {
    ...
    setContent((p: any) => ({
      ...
      media: {
        ...p.media,
        listrcutz: [...(p.media.listrcutz || []), ...urls],
      },
    }));
  };
    ...
    <div className="space-y-6 p-5" dir={rtl ? "rtl" : "ltr"}>
      {/* Connection Centre top nav */}
      <div className="mb-4 flex flex-wrap items-center gap-2 text-sm">
        <span className="mr-2 font-semibold">Connection Centre</span>
        ...
        <a
          href="/logout"
          className="rounded-full border border-neutral-300 px-3 py-1 text-neutral-500 hover:bg-neutral-50"
        >
          Logout
        </a>
      </div>
        ...
        <div className="flex flex-wrap items-center gap-4 px-5 py-4">
          <div className="flex items-center gap-2">
            ...
            <button
              ...
              onClick={() =>
                setAgents((l) => [
                  ...l,
                  { name: `Agent ${l.length + 1}`, avatarUrl: "" },
                ])
              }
            >
              {ui.addAgent}
          ...
          <div className="ml-auto min-w-0 text-right">
            <div className="text-[11px] text-neutral-500">
              {content.address?.place_name || ""}
            </div>
            <div className="text-[16px] font-semibold tracking-[-0.01em] text-neutral-900">
              {content.price || "-"}
            </div>
          </div>
        </div>
        ...
        <div className="grid grid-cols-12 gap-3">
          ...
          <label className="col-span-12 md:col-span-8">
            ...
            <input
              ...
              onChange={(e) =>
                setContent({
                  ...content,
                  address: { place_name: e.target.value },
                })
              }
            />
          </label>
          ...
          <label className="col-span-6 md:col-span-3">
            ...
            <select
              ...
              onChange={(e) =>
                setContent({ ...content, campaign: e.target.value })
              }
            >
          ...
          <label className="col-span-6 md:col-span-3">
            ...
            <input
              ...
              onChange={(e) =>
                setContent({
                  ...content,
                  nabers: Number(e.target.value || 0),
                })
              }
            />
          </label>
          ...
          <label className="col-span-6 md:col-span-3">
            ...
            <input
              className={ic}
              value={content.solarWattage}
              onChange={(e) =>
                setContent({
                  ...content,
                  solarWattage: e.target.value,
                })
              }
            />
          </label>
          ...
          <label className="col-span-6 md:col-span-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <select
                ...
                value={content.sH}
                onChange={(e) =>
                  setContent({ ...content, sH: e.target.value })
                }
              >
                {Array.from(
                  { length: 12 },
              ...
              <select
                ...
                value={content.sM}
                onChange={(e) =>
                  setContent({ ...content, sM: e.target.value })
                }
              >
                {["00", "15", "30", "45"].map((m) => (
              ...
              <select
                ...
                value={content.sAP}
                onChange={(e) =>
                  setContent({ ...content, sAP: e.target.value })
                }
              >
                {["AM", "PM"].map((x) => (
          ...
          <label className="col-span-6 md:col-span-4">
            ...
            <div className="grid grid-cols-3 gap-2">
              <select
                ...
                value={content.eH}
                onChange={(e) =>
                  setContent({ ...content, eH: e.target.value })
                }
              >
                {Array.from(
                  { length: 12 },
              ...
              <select
                ...
                value={content.eM}
                onChange={(e) =>
                  setContent({ ...content, eM: e.target.value })
                }
              >
                {["00", "15", "30", "45"].map((m) => (
                  <option key={m} value={m}>
              ...
              <select
                ...
                value={content.eAP}
                onChange={(e) =>
                  setContent({ ...content, eAP: e.target.value })
                }
              >
                {["AM", "PM"].map((x) => (
                  <option key={x} value={x}>
      ...
      <div className="rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm">
        ...
        <MainFeedCard
          ...
          UI={{
            en: {
              solar: UI.en.solar,
              evInstalled: UI.en.evInstalled,
              evYes: "Yes",
              evNo: "No",
            },
            "zh-Hans": {
              solar: UI["zh-Hans"]?.solar,
              evInstalled: UI["zh-Hans"]?.evInstalled,
              evYes: "是",
              evNo: "否",
            },
            yue: {
              solar: UI.yue?.solar,
              evInstalled: UI.yue?.evInstalled,
              evYes: "是",
              evNo: "否",
            },
            pa: {
